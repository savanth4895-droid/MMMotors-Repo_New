...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .logo-box{width:52px;height:52px;border:2.5px solid #B8860B;border-radius:4px;display:flex;align-items:center;justify-content:center;font-size:26px;font-weight:900;color:#B8860B;font-style:italic;letter-spacing:-2px;flex-shrink:0}
